...
public class SetViewTemplateNodeTestCase extends BaseFlowTestCase {
    ...
    public void testStaticViewNode() {
        ...
        FlowContext logicContext = executeFlow("org.neuro4j.flows.nodes.viewnode.SetViewTemplate-StartNode1Static");
    ...
    // executeFlowAndReturnObject("org.neuro4j.flows.nodes.viewnode.SetViewTemplate-StartNodeDynamic",
    // SWFConstants.AC_VIEW_TEMPLATE);
    //
    ...
    // try {
    // String templateName = (String)
    // executeFlowAndReturnObject("org.neuro4j.flows.nodes.viewnode.SetViewTemplate-StartNodeSD",
    // SWFConstants.AC_VIEW_TEMPLATE);
    //
    // assertEquals("hello1.jsp", templateName);
    //
