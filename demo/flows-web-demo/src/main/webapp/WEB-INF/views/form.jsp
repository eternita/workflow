...
<body>
	...
	<br/>
	<img alt="" src="resources/images/FormController.png">
	<br>
	<b>Flow: org.springframework.samples.mvc.form.SimpleFlow-Start:</b>		
	<br/>
	<img alt="" src="resources/images/SpringForm.jpg">	
	<br><br/>
	<b>ProcessForm custom block:</b>		
	<br/>
	<img alt="" src="resources/images/FormCustomBlock.jpg">
<c:if test="${!ajaxRequest}">
</body>
</html>
</c:if>