...
public class SimpleController extends AbstractWorkflowController{
	...
	public @ResponseBody String simple2(HttpServletRequest request) throws FlowExecutionException {		
		FlowContext context = processWorkflow("org.springframework.samples.mvc.simple.SimpleFlow-StartNode2", new WorkflowRequest());
		return "message";
	}
