...
public class ViewsController extends AbstractWorkflowController{
	...
	public String prepare(Model model) throws FlowExecutionException {
		model.addAttribute("foo", "bar");
		model.addAttribute("fruit", "apple");
		FlowContext context =  processWorkflow("org.springframework.samples.mvc.views.ViewFlow-Start", model, null, null);
		return "views/html";
	}
