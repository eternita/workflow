...
import static org.neuro4j.workflow.core.CustomBlockNoDefaultConstructor.IN_PARAM;
...
@ParameterDefinitionList(input = {
		@ParameterDefinition(name = IN_PARAM, isOptional = true, type = "java.lang.String") }, output = {})
public class CustomBlockNoDefaultConstructor implements ActionBlock {
	
	public CustomBlockNoDefaultConstructor(String param){
